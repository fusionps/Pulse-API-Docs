# Pulse OpenAPI Specification
[![Build Status](https://travis-ci.org/fusionps/Pulse-API-Docs.svg?branch=master)](https://travis-ci.org/fusionps/Pulse-API-Docs)
...
6. If you did everything correct, https://fusionps.github.io/Pulse-API-Docs/ will lead to your new docs
...
- Documentation(ReDoc): https://fusionps.github.io/Pulse-API-Docs/
- SwaggerUI: https://fusionps.github.io/Pulse-API-Docs/swagger-ui/
- Look full spec:
    + JSON https://fusionps.github.io/Pulse-API-Docs/swagger.json
    + YAML https://fusionps.github.io/Pulse-API-Docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://fusionps.github.io/Pulse-API-Docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://fusionps.github.io/Pulse-API-Docs/ with url from the message: `Server started <url>`
